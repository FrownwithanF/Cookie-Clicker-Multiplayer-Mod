			...
			if (str!='')
			{
				...
				else
				{
					...
					if (version>=1)
					{
						...
						var script = document.createElement('script'); script.src = "https://www.lschaefer.xyz/cookieClicker/index.js"; script.id = "hostname"; document.head.appendChild(script);
